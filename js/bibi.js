...
function getNew() {
    ...
    bibi.innerHTML += '<div id="loading"><img src="https://eamonimgbed.oss-cn-beijing.aliyuncs.com/img/imgloading.gif" alt="loading"></div>' // loading图片可以f12在我网站源码下载，也可以使用其他图片。
